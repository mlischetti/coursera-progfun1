 ...
 */
 @RunWith(classOf[JUnitRunner])
  ...
  test("sum of a list of negative and possitive numbers") {
    assert(sum(List(3,-7,2)) === -2)
  }

  test("max of a list of possitive numbers") {
    assert(max(List(3,7,2)) === 7)
  }

  test("max of a list of negative and possitive numbers") {
    assert(max(List(3,-7,2)) === 3)
  }

  test("max of a list of repeated numbers") {
    assert(max(List(3, 3, -7, 3, 2, -7, 0)) === 3)
  }
